  ...
  <div className="grid items-center justify-center gap-4 px-4 text-center md:px-6 w-full py-12">
    <BlurFade delay={BLUR_FADE_DELAY * 16}>
      <div className="space-y-6">
        ...
        {/* Contact Form */}
        <form className="space-y-6 max-w-lg mx-auto" action="/submit" method="POST">
          ...
          <button
            type="submit"
            className="w-small inline-block rounded-lg bg-foreground text-background px-3 py-2 text-sm"
          >
            Send Message
          </button>
        </form>
